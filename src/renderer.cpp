...
void Renderer::CreatePipelines() {
	...
	//
	{
		auto pipelineConfig           = Pipeline::CreatePipelineConfigInfo(m_Swapchain->GetWidth(), m_Swapchain->GetHeight(), VK_PRIMITIVE_TOPOLOGY_TRIANGLE_LIST, VK_CULL_MODE_BACK_BIT, true, true);
	...
	//
	{
		auto pipelineConfig       = Pipeline::CreatePipelineConfigInfo(m_Swapchain->GetWidth(), m_Swapchain->GetHeight(), VK_PRIMITIVE_TOPOLOGY_TRIANGLE_LIST, VK_CULL_MODE_FRONT_BIT, false, false);
		pipelineConfig.renderPass = m_Swapchain->GetGeometryRenderPass();
